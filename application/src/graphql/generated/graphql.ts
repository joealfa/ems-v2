...
export type CreateEmploymentInput = {
  appointmentStatus?: InputMaybe<Scalars['Int']['input']>;
  dateOfOriginalAppointment?: InputMaybe<Scalars['DateTime']['input']>;
  depEdId?: InputMaybe<Scalars['String']['input']>;
  eligibility?: InputMaybe<Scalars['Int']['input']>;
  employmentStatus?: InputMaybe<Scalars['Int']['input']>;
...
export type CreatePersonInput = {
  ...
  civilStatus?: InputMaybe<Scalars['Int']['input']>;
...
export type Eligibility =
  | 'CIVIL_SERVICE_PROFESSIONAL'
  | 'CIVIL_SERVICE_SUB_PROFESSIONAL'
  | 'LET'
  | 'OTHER'
  | 'PBET';
